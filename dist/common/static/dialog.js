...
(function (root, factory) {
	...
	__dialog.prototype = {
		...
		__open: function __open(callBack) {
			var _this = this,
			    el = this.el,
			    OP = this.options,
		...
		__close: function __close(callBack) {
			var el = this.el,
			    OP = this.options;
	...
	var DIALOG = (function () {
		...
		return {
			dialog: function dialog(options, isMsg) {
			...
			tipDialog: function tipDialog(msg) {
			...
			msgDialog: function msgDialog(msg) {
				var _msgDialog = this.dialog({
					id: "msgDialog",
					...
					footer: [{ name: "确定", className: "ui-msgDialogBtn" }],
					blindEvent: [{
						ele: ".ui-msgDialogBtn",
						type: "click",
						fn: function fn() {
			...
			simpleDialog: function simpleDialog(msg, sureFunction, cancleFunction) {
				var _simpleDialog = this.dialog({
					...
					footer: [{ name: "确定", className: "ui-simpleDialogSureBtn" }, { name: "取消", className: "ui-simpleDialogCancleBtn" }],
					blindEvent: [{
