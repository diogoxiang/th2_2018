...
require.async(["lib/vue/vue.2.13.min", "components/common/common", "extend", "apiData", "dialog", "lib/wxjs/jweixin-1.2.0"], function (Vue, app, ext, api, dialog, wx) {
  var WIN = window;
  var DOC = document;
  ...
  ext.wxIntercept(function (barData, wxLogin) {
    ...
    var vm = new Vue({
      ...
      methods: {
        ...
        clickBtn: function clickBtn(str) {
          switch (str) {
            case 'rule':
              vm.showMask = true;
              vm.showRule = true;
         ...
         * 显示活动规则
         */
        showRulePop: function showRulePop() {
          vm.showMask = true;
          vm.showRule = true;
        },
        /**
         * 跨目录跳转
         */
        goTolink: function goTolink(eurl, obj, loc) {
         ...
         * 获取信息列表
         */
        getActivityIdForAvtivityList: function getActivityIdForAvtivityList() {

          api.getActivityIdForAvtivityList(2).done(function (res) {
            // console.log(res);
            if (res.code == 200) {
              /**
        ...
        getSdk: function getSdk() {
          ...
          api.getJssdk(eurl).done(function (res) {
            console.log(res);
            if (res.code == 200) {
